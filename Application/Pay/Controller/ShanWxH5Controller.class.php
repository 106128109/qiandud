...
{
    protected $privateCertPath = '/www/wwwroot/qdudu.cn/Data/cert/mbhy.pfx';

    protected $publicCertPath = '/www/wwwroot/qdudu.cn/Data/cert/sand.cer';
    ...
    public function Pay($array)
    {
        ...
        if ($result['head']['respCode'] == '000000') {
            $data['amount'] = bcdiv($data['amount'], 100, 2);
            $this->showQRcode($result['body']['qrCode'], $data, 'weixin');
        } else {
            $this->showMessage($result['head']['respMsg']);
        }
    }
